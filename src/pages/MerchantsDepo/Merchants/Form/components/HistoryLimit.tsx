  ...
  const headCells: HeadCells<any>[] = [
    {
      ...
      label: 'Updated At',
      format: (value) =>
        moment(value?.updatedAt ? value?.updatedAt : undefined).format(
          'DD MMM YYYY ',
        ),
    },
    {
      id: 'Old limit',
      label: 'Old Limit',
      format: (value) => `Rp ${numberSeperator(value?.old_limit || '0')}`,
    },
    {
      id: 'New Limit',
      label: 'New Limit',
      format: (value) => `Rp ${numberSeperator(value?.new_limit || '0')}`,
    },
  ];
  return (
    <Box p="24px">
